...
or these hash values:

  > md5:  e6fa34c8803f1a1ce22b8a89224495bf  
  > sha1: a5c8ce53c8d4c5d0188b095e97fee8e8bded0777

The difference being that at some point archives generated by the above link
started adding an extra line to the manifest file included in the archive:

    --- fossil-v1.18-old/manifest   2011-07-13 16:03:41.000000000 -0700
    +++ fossil-v1.18-new/manifest   2011-07-13 16:03:41.000000000 -0700
    @@ -325,3 +325,4 @@
     R 675d9f02faa4c8ad97474da91bcc8b39
     U drh
     Z 04f0f6f457863c33e57b89a526d699e9
    +# Remove this line to create a well-formed manifest.

The original version (without the extra line) is included in the archives
subdirectory for convenience and will be automatically used by the build script.
